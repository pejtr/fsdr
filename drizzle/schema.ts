...
export const users = mysqlTable("users", {
  ...
  creatorUpdatesEnabled: boolean("creatorUpdatesEnabled").default(true).notNull(),
  productTipsEnabled: boolean("productTipsEnabled").default(true).notNull(),
  specialOffersEnabled: boolean("specialOffersEnabled").default(true).notNull(),
